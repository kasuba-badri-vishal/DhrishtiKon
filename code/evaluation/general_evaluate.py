...
def main():
    for i in range(1, 11):
        ...
        INPUT_JSON_FILE = f"/data/BADRI/FINAL/THESIS/GRVQA/main/outputs/json/doctr_grounding_annotations_{i}.json"
        # INPUT_JSON_FILE = f"/data/BADRI/FINAL/THESIS/GRVQA/main/outputs/json/doctr_inhouse_vqa_grounding_annotations_{i}.json"
        ...
        out_img_dir = os.path.join(OUTPUT_IMG_DIR, EVALUATION_LEVEL + "_" + str(i))
