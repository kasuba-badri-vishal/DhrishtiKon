...
JSON_FILE = "/data/BADRI/FINAL/THESIS/GRVQA/main/outputs/json/doctr_llama_vqa_grounding_annotations_line_final.json"
OUT_IMG_DIR = "/data/BADRI/FINAL/THESIS/GRVQA/main/outputs/images/algorithm_llama/"
...
out_dir = os.path.join(OUT_IMG_DIR, evaluation_level)
...
for image_name, qa_data in data.items():
    ...
    for qa in qa_data:
        ...
        if evaluation_level == 'word':
            ...
            predictions[img_id] = get_processed_prediction_bboxes(qa['block_level_predictions'], 'block')
        elif evaluation_level == 'line':
            predictions[img_id] = get_processed_prediction_bboxes(qa['line_level_matches'], 'line')
        ...
        # save the image
        img.save(os.path.join(out_dir, qa["id"] + '.png'))
